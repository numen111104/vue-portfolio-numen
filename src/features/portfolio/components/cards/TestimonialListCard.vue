<template>
  <div
    ref="cardElement"
    class="p-6 card transition-all duration-300 ease-in-out hover:scale-105 animate-on-scroll fade-in-up-on-scroll"
  ...
  >
    <div class="flex items-center gap-4 mb-4">
      ...
      />
      <div>
        <h4 class="font-semibold text-white text-lg">{{ testimonial.author_name }}</h4>
