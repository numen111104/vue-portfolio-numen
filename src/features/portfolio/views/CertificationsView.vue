...
import CertificationDetailModal from '@/shared/components/CertificationDetailModal.vue';
import { IconLoader2 } from '@tabler/icons-vue';
import CertificationCard from '@/features/portfolio/components/cards/CertificationCard.vue';
