<template>
  ...
  >
    <div class="mb-10 text-center md:w-1/2 md:text-left md:mb-0 animate-on-scroll fade-in-left-on-scroll">
      ...
      >
      <h1
        class="text-4xl font-semibold leading-tight text-white uppercase sm:text-5xl md:text-6xl"
      >
      ...
      <h3
        class="max-w-lg mx-auto mt-4 text-2xl font-semibold sm:text-3xl text-brand-text md:mx-0"
      >
        {{ settings.name }}
      </h3>
      <h4
        class="max-w-lg mx-auto mt-1 text-xl font-medium capitalize sm:text-2xl text-brand-text md:mx-0"
      >
        {{ settings.title }}
      </h4>
      <a
        :href="settings.button_link"
        class="inline-flex items-center mt-8 space-x-2 btn btn-primary group"
      >
    ...
    <div
      class="relative justify-center flex md:w-1/2 animate-on-scroll zoom-in-on-scroll"
